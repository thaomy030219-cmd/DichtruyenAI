            ...
            <div className="bg-white rounded-3xl shadow-2xl w-full max-w-md overflow-hidden animate-in zoom-in-95 duration-200 p-6">
                ...
                <div className="space-y-3">
                    ...
                    <button 
                        ...
                        className="w-full p-4 bg-white border-2 border-slate-200 hover:border-primary-400 hover:bg-primary-50 rounded-2xl flex items-center gap-4 transition-all group text-left"
                    >
                        <div className="p-3 bg-slate-100 group-hover:bg-white rounded-xl text-slate-500 group-hover:text-primary-600 transition-colors shadow-sm">
